    ...
    class Program
    {
        static void Main(string[] args)
        {
            List<Customer> customers = new List<Customer>
            {
                ...
                new Customer { ID="B", City="Mumbai", Country="India", Region="Asia", Sales=12000},
                new Customer { ID="C", City="Karachi", Country="Pakistan", Region="Asia", Sales=15000 },
            ...
            var queryResult = customers.Select(c => c.Region).Distinct();

            // query syntax version
            // var queryResult = (from c in customers select c.Region).Distinct();
