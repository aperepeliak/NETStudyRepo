...
<body>
    <form id="form1" runat="server">
        ...
        <asp:FormView ID="fvDataBinding" runat="server"
            DataKeyNames="CarID" ItemType="Inventory" DefaultMode="Insert"
            InsertMethod="SaveCar"
            UpdateMethod="UpdateCar"
            SelectMethod="GetCar">
        ...
        <asp:ValidationSummary runat="server" ShowModelStateErrors="true"
            ForeColor="Red" HeaderText="Check the following errors:" />
